...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            //get API from Laravel Backend 
            axios.get(`https://api-gofit.200710947.com/api/jadwal_umum/${route.params.id}`).then(response => {
                //assign state posts with response data
                jadwal_umum.value = response.data.data
                console.log(jadwal_umum.value)              
            }).catch(error => {
                console.log(error.response.data)
            })
        })
        ...
        function update() { 
            ...
            axios.put(`https://api-gofit.200710947.com/api/jadwal_umum/${route.params.id}`,{ 
                ...
                jam_mulai : jam_mulai,
                 ...
                 router.push({ name: 'jadwal_umum.index' }) 
                }).catch(error => { 
